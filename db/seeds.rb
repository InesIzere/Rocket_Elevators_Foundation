...
blockchain_list = [
  [ "ProjectOffice", 0xae18965e391346bEA47061D4FDA8BeD50Fec40f0 ],
  [ "MaterialProvider", 0x89aaed2013dE7e45E3410cf5d5A390Bfd0b075d9 ],
  [ "SolutionManufacturing", 0xd5943e8E699Fa7b29e95acA064326b4E550470b2 ],
  [ "QualitySecurity ", 0xe809474FBa1879cAf8a5b33eaa7019B645980A98]
]

blockchain_list.each do |nodeName, address|
  Blockchain.create( nodeName: nodeName, address: address )
end
